...
Me encuentro en desarrollo de una API REST FULL totalmente DINAMICA, en PHP Nativo + MySQL.
...
En este momento me encuentro configurando el GET, para que sea dinámico y 100% configurable desde los parámetros, luego continuare con los verbos PUT, POST y DELETE.
